...
import { ChevronSelectorVertical, LogOut01, Moon01, Sun, User01 } from "@untitledui/icons";
...
export const NavAccountCard = ({
    ...
    // Collapsed version - just show avatar
    if (isCollapsed) {
        return (
            <AriaDialogTrigger>
                <AriaButton
                ...
                >
                    <Avatar status={selectedAccount.status} src={selectedAccount.avatar} size="md" alt={selectedAccount.name} />
                </AriaButton>
                <AriaPopover
    ...
    // Expanded version - show full card
    return (
