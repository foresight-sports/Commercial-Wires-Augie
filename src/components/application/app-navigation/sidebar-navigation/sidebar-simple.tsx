...
import { ThemeToggle } from "@/components/domain/shared/theme-toggle";
            ...
            <div className="flex flex-col gap-5 px-4 lg:px-5">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <ForesightLogo className="h-7 text-brand-600" />
                        <span className="text-lg font-semibold text-primary">{t("common.app.name")}</span>
                    </div>
                    <ThemeToggle />
                </div>
